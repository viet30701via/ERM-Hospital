  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-8 text-white shadow-xl">
        <h1 className="text-3xl font-bold mb-2">Welcome to VIA Hospital Dashboard! 👋</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-semibold text-green-600 bg-green-100 px-3 py-1 rounded-full">+12%</span>
          </div>
          <h3 className="text-gray-600 text-sm font-medium">Total Patients</h3>
          <p className="text-3xl font-bold text-gray-800 mt-2">{stats.totalPatients.toLocaleString()}</p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-semibold text-purple-600 bg-purple-100 px-3 py-1 rounded-full">Today</span>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-semibold text-blue-600 bg-blue-100 px-3 py-1 rounded-full">On Duty</span>
          </div>
          <h3 className="text-gray-600 text-sm font-medium">Active Doctors</h3>
          <p className="text-3xl font-bold text-gray-800 mt-2">{stats.activeDoctors}</p>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm font-semibold text-red-600 bg-red-100 px-3 py-1 rounded-full">Urgent</span>
          </div>
          <h3 className="text-gray-600 text-sm font-medium">Emergency</h3>
          <p className="text-3xl font-bold text-gray-800 mt-2">{stats.emergencyCases}</p>
                ...
                <div className="flex items-center gap-2">
                  <span
                    className={`text-xs font-semibold px-2 py-1 rounded-full ${
                      patient.status === "Active" ? "bg-green-100 text-green-600" : "bg-blue-100 text-blue-600"
                    }`}
                  >
                    {patient.status}
                  </span>
                  <Link href={`/medical-records/${patient.id}`} className="text-blue-600 hover:text-blue-700">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    </svg>
                  </Link>
